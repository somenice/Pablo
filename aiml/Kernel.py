...
ser = serial.Serial('/dev/tty.AdafruitEZ-Link3f5a-SPP', 19200)
...
class Kernel:
    ...
    def __init__(self):
        ...
        self._botPredicates = {}
        self.setBotPredicate("name", "Pahblow")
        self.setBotPredicate("master", "Andrew Smith")
        self.setBotPredicate("location", "Whistler")
    ...
    def respond(self, input, sessionID = _globalSessionID):
        ...
        ser.write(finalResponse.encode(self._textEncoding) + "\n")   # Send Serial data    
